...
<div>
  <div id="t_bodyContainer" class="container box">
    ...
    <div class="tabs is-boxed">
      <ul>
        <li class="t_semesterTab" :class="{'is-active' : curSemester === 0 }" @click="changeSemester(0)"><a>FALL 2024</a></li>
        <li class="t_semesterTab" :class="{'is-active' : curSemester === 1 }" @click="changeSemester(1)"><a>WINTER 2025</a></li>
      </ul>
    </div>
